                        ...
                        children: [
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              labelText: "Email",
                              prefixIcon: const Icon(Icons.email, color: Colors.black), // Changed to black
                              border: OutlineInputBorder(
                                borderRadius: BorderRadius.circular(10),
                              ),
                              labelStyle: const TextStyle(color: Colors.black), // Added
                            ),
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              suffixText: "Forgot?",
                              suffixStyle: const TextStyle(color: Colors.black), // Changed to black
                              labelStyle: const TextStyle(color: Colors.black), // Added
                            ),
                            style: const TextStyle(color: Colors.black), // Force black text
                          ),
