...
import 'package:rentify_flat_management/features/home/presentation/view/bottom_view/edit_profile.dart'; // Add this import
...
class _DashboardViewState extends State<DashboardView> {
  final PageController _hotDealsController =
      PageController(viewportFraction: 0.9);
  final PageController _cheapController = PageController(viewportFraction: 0.9);
  final PageController _expensiveController =
      PageController(viewportFraction: 0.9);
  static const String _baseUrl =
      'http://192.168.101.11:3000'; // Same as EditProfile
                ...
                FutureBuilder(
                  ...
                  builder: (context, snapshot) {
                    ...
                    final imageUrl = user?.image != null &&
                        ...
                        ? '$_baseUrl/uploads/profile/${user.image}' // Same as EditProfile
                        : null;
              ...
              child: BlocConsumer<RoomBloc, RoomState>(
                listener: (context, state) {
                  if (state.isLoading) {
                    ...
                    print(
                        'RoomBloc State: Loaded - ${state.rooms.length} rooms');
                  }
                },
  ...
  Widget _buildSection(String title, List<RoomEntity> rooms,
      PageController controller, Color color) {
    return Container(
